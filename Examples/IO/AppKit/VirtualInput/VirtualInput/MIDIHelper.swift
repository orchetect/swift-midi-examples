...
public final class MIDIHelper: Sendable {
    ...
    private let _eventHandler = Mutex<EventHandler?>(nil)
    ...
    private func createInput() {
        do {
            ...
            try midiManager.addInput(
                ...
                receiver: .events(options: [.filterActiveSensingAndClock, .bundleRPNAndNRPNDataEntryLSB]) { [weak self] events, timeStamp, source in
